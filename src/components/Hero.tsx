...
const Hero = () => {
  ...
  return (
    <section id="who-we-are" className="min-h-screen flex flex-col items-center justify-center text-center px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center max-w-6xl">
        <div className="relative mb-6 sm:mb-8">
          <div className="logo-wrap">
            <img 
              ...
              className="w-28 h-28 sm:w-36 sm:h-36 md:w-40 md:h-40 logo-animated" 
            />
          </div>
        </div>

        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold mb-4 max-w-4xl leading-tight px-2">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a 
            ...
            className="px-6 sm:px-8 py-3 sm:py-4 font-bold text-white rounded-lg btn-gradient transition-all duration-300 hover:scale-105 hover:shadow-neon-cyan text-sm sm:text-base"
          >
            Join Now
          </a>
        </div>
